...
\fancypagestyle{firstpage}{
  ...
  \chead{
      \begin{tabular}{|ccc|r|}
           ...
           &  &  &  \\
           &  {\large Departamento de matemáticas} &  & Andres Steven Puertas \\
           &  &  & apuertasl@unal.edu.co \\
           & {\large Teoría del riesgo actuarial} &  &  \\
           &  &  & \textbf{Docente:} \\
           & {\Large Análisis de siniestralidad mediante} &  & Alejandra Sanchez Vásquez \\
           & {\Large modelos de riesgo colectivo} &  & asanchezva@unal.edu.co \\
           &  &  &  \\
           \hline
      \end{tabular}\\
  }
